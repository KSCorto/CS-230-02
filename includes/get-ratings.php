...
$sqlAvg = "SELECT AVG(rating_num) AS AVGRATE FROM review WHERE item_id='id' ORDER BY rev_date DESC";
$sqlCount = "SELECT count(rating_num) AS Total FROM review WHERE item_id='$id'";
